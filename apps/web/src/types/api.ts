...
export interface Application { id: string; applicationNo: string; type: string; applicantId: string; applicantName: string; departmentName: string; requestedAmount: number; approvedAmount?: number; reason: string; status: string; approvalStage: 'manager' | 'budget_admin' | 'completed'; submittedAt?: string; reviewedAt?: string; }
